...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cmsplugin_custom_contact_customcontact', (
            ...
            ('redirect_url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'cmsplugin_custom_contact_customcontact')
