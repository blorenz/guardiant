...
from guardiant_plugins.cmsplugin_guardiant_contact.utils import class_for_path
...
from .models import GuardiantContact
...
class GuardiantContactPlugin(CMSPluginBase):
    model = GuardiantContact
    name = _("Guardiant Contact Form")
    render_template = "cmsplugin_guardiant_contact/contact.html"
    form = ContactAdminForm
    subject_template = "cmsplugin_guardiant_contact/subject.txt"
    email_template = "cmsplugin_guardiant_contact/email.txt"
    ...
    change_form_template = "cmsplugin_guardiant_contact/admin/plugin_change_form.html"
    ...
    def get_form(self, request, obj=None, **kwargs):
        ...
        return super(GuardiantContactPlugin, self).get_form(request, obj, **kwargs)
    ...
    def render_change_form(self, request, context, add=False, change=False, form_url='', obj=None):
        ...
        return super(GuardiantContactPlugin, self).render_change_form(request, context, add, change, form_url, obj)


plugin_pool.register_plugin(GuardiantContactPlugin)
