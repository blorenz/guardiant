...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DownloadableFile.src'
        db.alter_column(u'cmsplugin_file_gallery_downloadablefile', 'src', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DownloadableFile.src'
        raise RuntimeError("Cannot reverse this migration. 'DownloadableFile.src' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'DownloadableFile.src'
        db.alter_column(u'cmsplugin_file_gallery_downloadablefile', 'src', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
