...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FileGalleryPlugin'
        db.create_table(u'cmsplugin_filegalleryplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('template', self.gf('django.db.models.fields.CharField')(default='cmsplugin_file_gallery/gallery.html', max_length=255)),
        ))
        db.send_create_signal(u'cmsplugin_file_gallery', ['FileGalleryPlugin'])

        # Adding model 'DownloadableFile'
        db.create_table(u'cmsplugin_file_gallery_downloadablefile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inline_ordering_position', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cmsplugin_file_gallery.FileGalleryPlugin'])),
            ...
            ('downloadable_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'cmsplugin_file_gallery', ['DownloadableFile'])


    def backwards(self, orm):
        # Deleting model 'FileGalleryPlugin'
        db.delete_table(u'cmsplugin_filegalleryplugin')

        # Deleting model 'DownloadableFile'
        db.delete_table(u'cmsplugin_file_gallery_downloadablefile')
    ...
    models = {
        ...
        u'cmsplugin_file_gallery.downloadablefile': {
            ...
            'downloadable_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
