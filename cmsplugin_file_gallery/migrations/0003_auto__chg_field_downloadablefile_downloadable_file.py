...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DownloadableFile.downloadable_file'
        db.alter_column(u'cmsplugin_file_gallery_downloadablefile', 'downloadable_file', self.gf('django.db.models.fields.files.FileField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'DownloadableFile.downloadable_file'
        db.alter_column(u'cmsplugin_file_gallery_downloadablefile', 'downloadable_file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
