...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cmsplugin_gallery_image', 'link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Image.extended_content'
        db.add_column(u'cmsplugin_gallery_image', 'extended_content',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'GalleryPlugin.title'
        db.add_column(u'cmsplugin_galleryplugin', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'GalleryPlugin.slide_duration'
        db.add_column(u'cmsplugin_galleryplugin', 'slide_duration',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'cmsplugin_gallery_image', 'link')

        # Deleting field 'Image.extended_content'
        db.delete_column(u'cmsplugin_gallery_image', 'extended_content')

        # Deleting field 'GalleryPlugin.title'
        db.delete_column(u'cmsplugin_galleryplugin', 'title')

        # Deleting field 'GalleryPlugin.slide_duration'
        db.delete_column(u'cmsplugin_galleryplugin', 'slide_duration')
